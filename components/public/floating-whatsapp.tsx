...
export function FloatingWhatsApp({
  phone,
  message = "Hi, I'd like to ask about a stay.",
}: {
  /** International format without "+" (e.g. "9779742529499") */
  phone: string;
  message?: string;
}) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-soft-lg transition-transform hover:scale-105 active:scale-95 md:bottom-6 md:right-6"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
